...
test_chain_quote = {'symbol': 'SPY', 'status': 'SUCCESS',
        ...
        '2020-05-08:1': {'280.0': [
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P281', 'description': 'SPY May 8 2020 281 Put (Weekly)',
             ...
             'openInterest': 8600, 'timeValue': 0.26, 'theoreticalOptionValue': 0.255, 'theoreticalVolatility': 29.0,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P282', 'description': 'SPY May 8 2020 282 Put (Weekly)',
             ...
             'openInterest': 11578, 'timeValue': 0.34, 'theoreticalOptionValue': 0.345, 'theoreticalVolatility': 29.0,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P283', 'description': 'SPY May 8 2020 283 Put (Weekly)',
             ...
             'openInterest': 10305, 'timeValue': 0.44, 'theoreticalOptionValue': 0.455, 'theoreticalVolatility': 29.0,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P284', 'description': 'SPY May 8 2020 284 Put (Weekly)',
             ...
             'openInterest': 7821, 'timeValue': 0.59, 'theoreticalOptionValue': 0.585, 'theoreticalVolatility': 29.0,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P285', 'description': 'SPY May 8 2020 285 Put (Weekly)',
             ...
             'openInterest': 28374, 'timeValue': 0.75, 'theoreticalOptionValue': 0.76, 'theoreticalVolatility': 29.0,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P286', 'description': 'SPY May 8 2020 286 Put (Weekly)',
             ...
             'openInterest': 11801, 'timeValue': 0.98, 'theoreticalOptionValue': 0.975, 'theoreticalVolatility': 29.0,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P287', 'description': 'SPY May 8 2020 287 Put (Weekly)',
             ...
             'openInterest': 13799, 'timeValue': 1.22, 'theoreticalOptionValue': 1.235, 'theoreticalVolatility': 29.0,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P288', 'description': 'SPY May 8 2020 288 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 1.55, 'ask': 1.56, 'last': 1.55, 'mark': 1.56, 'bidSize': 129, 'askSize': 28,
             ...
             'quoteTimeInLong': 1588867938404, 'netChange': -3.68, 'volatility': 25.168, 'delta': -0.4, 'gamma': 0.072,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P290', 'description': 'SPY May 8 2020 290 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 2.41, 'ask': 2.43, 'last': 2.38, 'mark': 2.42, 'bidSize': 62, 'askSize': 151,
             ...
             'quoteTimeInLong': 1588867938347, 'netChange': -4.41, 'volatility': 24.02, 'delta': -0.55, 'gamma': 0.077,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P291', 'description': 'SPY May 8 2020 291 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 2.96, 'ask': 2.98, 'last': 2.97, 'mark': 2.97, 'bidSize': 18, 'askSize': 100,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P292', 'description': 'SPY May 8 2020 292 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 3.58, 'ask': 3.61, 'last': 3.65, 'mark': 3.6, 'bidSize': 100, 'askSize': 35,
             ...
             'quoteTimeInLong': 1588867938334, 'netChange': -4.89, 'volatility': 22.841, 'delta': -0.705, 'gamma': 0.07,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P293', 'description': 'SPY May 8 2020 293 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 4.29, 'ask': 4.33, 'last': 4.33, 'mark': 4.31, 'bidSize': 30, 'askSize': 25,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P294', 'description': 'SPY May 8 2020 294 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 5.06, 'ask': 5.11, 'last': 5.08, 'mark': 5.09, 'bidSize': 100, 'askSize': 25,
             ...
             'quoteTimeInLong': 1588867938846, 'netChange': -5.32, 'volatility': 21.734, 'delta': -0.84, 'gamma': 0.052,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P295', 'description': 'SPY May 8 2020 295 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 5.91, 'ask': 5.96, 'last': 5.9, 'mark': 5.94, 'bidSize': 20, 'askSize': 100,
             ...
             'quoteTimeInLong': 1588867938768, 'netChange': -5.47, 'volatility': 21.316, 'delta': -0.89, 'gamma': 0.041,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P296', 'description': 'SPY May 8 2020 296 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 6.8, 'ask': 6.84, 'last': 6.88, 'mark': 6.82, 'bidSize': 100, 'askSize': 1,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P297', 'description': 'SPY May 8 2020 297 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 7.73, 'ask': 7.79, 'last': 7.75, 'mark': 7.76, 'bidSize': 100, 'askSize': 15,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P298', 'description': 'SPY May 8 2020 298 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 8.69, 'ask': 8.74, 'last': 8.72, 'mark': 8.72, 'bidSize': 20, 'askSize': 100,
             ...
             'quoteTimeInLong': 1588867938259, 'netChange': -5.6, 'volatility': 18.289, 'delta': -0.985, 'gamma': 0.009,
            ...
            {'putCall': 'PUT', 'symbol': 'SPY_050820P299', 'description': 'SPY May 8 2020 299 Put (Weekly)',
             'exchangeName': 'OPR', 'bid': 9.66, 'ask': 9.72, 'last': 9.72, 'mark': 9.69, 'bidSize': 100, 'askSize': 10,
        ...
        for key in nested_dict.keys():
            if (type(nested_dict[key]) is list) or (type(nested_dict[key]) is dict):
                ...
                if type(nested_dict[key]) in [str, bool, type(None)]:
                    ...
                    data_type = np.float
                    group.create_dataset(key, dtype=data_type)
